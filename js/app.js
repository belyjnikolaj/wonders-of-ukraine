 ...
 */
    ...
    (() => {
        ...
        const telInputMask = new Inputmask("+38 (099) 999-99-99");
        telInputMask.mask(telInputs);
        ...
        function initSliders() {
            if (document.querySelector(".tours__slider")) new swiper_core_Swiper(".tours__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".reviews__slider")) new swiper_core_Swiper(".gallery__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
